...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals,
        ...
        return new RTLXOri(regE1, reg, succ);
    }// toRTL
...
class UPPLoad extends UPPExpr {
    ...
    RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals,
            ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister addrReg = addr.getPRegister(locals);
        return new RTLLoad(addrReg, reg, succ);
    }// toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals,
        ...
        RTLGtz gtz = new RTLGtz(condReg, ni1, ni2);
        return cond.toRTL(locals, globals, condReg, gtz);
    }// toRTL
...
class UPPProcCall extends UPPInst {
    ...
    RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals,
            ArrayList<String> globals, RTLInst succ) {
        ArrayList<PRegister> argsReg = new ArrayList<PRegister>();
        for (UPPExpr arg : args) {
            argsReg.add(arg.getPRegister(locals));
        }
        return new RTLProcCall(callee, argsReg, succ);
    }// toRTL
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL(ArrayList<Pair<String, PRegister>> locals,
        ...
        for (Pair<String, PRegister> elements : locals) {
