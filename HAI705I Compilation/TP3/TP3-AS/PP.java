...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr offset = new UPPMul(index.toUPP(locals), new UPPCte(4));
        return new UPPLoad(new UPPAdd(arr.toUPP(locals), offset));
    }// toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        UPPExpr offset = new UPPMul(new UPPCte(4), index.toUPP(locals));
        return new UPPStore(new UPPAdd(arr.toUPP(locals), offset), val.toUPP(locals));
    }// toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        for (int i = 0; i < args.size(); i++) {
            nargs.add(args.get(i).toUPP(locals));
        }
